...
# copy from `https://github.com/folke/tokyonight.nvim/blob/f2ed28707a0ad49047d9b733395ea205ea09f517/extras/tmux/tokyonight_moon.tmux`
...
set -g status-right "#[fg=#82aaff,bg=#1e2030]#{prefix_highlight}#[fg=#3b4261,bg=#1e2030,nobold,nounderscore,noitalics]#[fg=#82aaff,bg=#3b4261] %Y-%m-%d  %I:%M %p #[fg=#82aaff,bg=#3b4261,nobold,nounderscore,noitalics]#[fg=#1b1d2b,bg=#82aaff,bold] #h "
